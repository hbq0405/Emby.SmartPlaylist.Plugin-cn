...
cp -v backend/SmartPlaylist/bin/Release/netstandard2.0/publish/SmartPlaylist.dll /var/lib/emby/plugins/SmartPlaylist.dll
cp -v backend/SmartPlaylist/bin/Release/netstandard2.0/publish/SmartPlaylist.pdb /var/lib/emby/plugins/SmartPlaylist.pdb
